...
class {
	...
	public = {
		...
		setItemFont = dgsOOP.genOOPFnc("dgsComboBoxSetItemFont",true),
		getItemFont = dgsOOP.genOOPFnc("dgsComboBoxGetItemFont"),
		setItemImage = dgsOOP.genOOPFnc("dgsComboBoxSetItemImage",true),
		getItemImage = dgsOOP.genOOPFnc("dgsComboBoxGetItemImage"),
		removeItemImage = dgsOOP.genOOPFnc("dgsComboBoxRemoveItemImage",true),
